        ...
        <div class="row">
            ...
            <div class="col-10 content-section admin-dashboard-title">
                <ValidationObserver v-slot="{ handleSubmit }">
                    <form v-on:submit.prevent="handleSubmit(editBankAccount)">
...
import { GET_BANK_ACCOUNT, EDIT_BANK_ACCOUNT } from '../../store/action_types'
...
export default {
    ...
    methods: {
        ...
        setValues() {
            ...
            this.iso3 = this.bank.iso3
            this.accountNumber = this.bank.accountNumber
            this.accountName = this.bank.accountName
            this.swiftCode = this.bank.swiftCode
        },
        getBankAccount() {
            this.$store.dispatch(GET_BANK_ACCOUNT, { id: this.$route.params.id })
        },  
        editBankAccount() {
            let payload = {
                ...
                accountName: this.duration,
                swiftCode: this.duration
            }
            this.$store.dispatch(EDIT_BANK_ACCOUNT, payload)
        }
    },
    mounted() {
        this.getBankAccount()
