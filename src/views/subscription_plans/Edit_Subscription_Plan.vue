        ...
        <div class="row">
            ...
            <div class="col-10 content-section admin-dashboard-title">
                <ValidationObserver v-slot="{ handleSubmit }">
                    <form v-on:submit.prevent="handleSubmit(editSubscriptionPlan)">
...
import { GET_SUBSCRIPTION_PLAN, EDIT_SUBSCRIPTION_PLAN } from '../../store/action_types'
...
export default {
    ...
    methods: {
        ...
        setValues() {
            ...
            this.totalPrice = this.subscriptionPlan.totalPrice,
            this.duration = this.subscriptionPlan.duration
        },
        getSubscriptionPlan() {
            this.$store.dispatch(GET_SUBSCRIPTION_PLAN, { id: this.$route.params.id })
        },  
        editSubscriptionPlan() {
            ...
            this.$store.dispatch(EDIT_SUBSCRIPTION_PLAN, payload)
        }
    },
    mounted() {
