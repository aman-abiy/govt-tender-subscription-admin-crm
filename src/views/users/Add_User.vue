        ...
        <div class="row">
            ...
            <div class="col-10 content-section admin-dashboard-title">
                <ValidationObserver v-slot="{ handleSubmit }">
                    <form v-on:submit.prevent="handleSubmit(addUser)">
                                            ...
                                            <template v-for="(role, index) in ROLES">
                                                <div v-bind:key="index" class="input-group">
                                                    <div class="role-checkbox custom-control custom-checkbox">
                                                        <input v-model="roles" :value="role" type="checkbox" class="custom-control-input" :id="`role${index+1}`" :checked="role == 'user'">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <ValidationProvider name="mobile" rules="" v-slot="{ errors }">
                                                    ...
                                                    <MazPhoneNumberInput class="auth-input" id="mobile" @update="mobile = $event" default-country-code="ET" :preferred-countries="['ET', 'US', 'GB']"/>
                                                    <small class="form-text text-muted">{{ errors[0] }}</small>
                                                </ValidationProvider>
                                                <br>
...
import { ADD_USER } from '../../store/action_types'
...
export default {
    ...
    methods: {
        ...
        addUser() {
            ...
            this.$store.dispatch(ADD_USER, payload)
        }
    },
    mounted() {}
}
